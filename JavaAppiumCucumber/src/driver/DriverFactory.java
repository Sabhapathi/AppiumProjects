...
public class DriverFactory {
    ...
    public static final String appName = "TimeTrack_ATT.apk";
    public static final String APP_DIR = "C:\\Users\\Sabhapathi.akkipalli\\workspace\\AppiumCucumberDemo-master\\AppiumCucumberDemo-master\\apps\\";

//    @BeforeSuite
//    public void startappium() throws IOException, InterruptedException{
//        Runtime.getRuntime().exec("cmd /c start C:\\Users\\Sabhapathi.akkipalli\\startappium.bat");
//        Thread.sleep(7000);
//    }
   ...
   //ANDROID DRIVER
    ...
    protected void initializeAndroidDriver() throws MalformedURLException {
        String DvcREmulator = new PropertyReader().readProperty("DeviceREmulator");
