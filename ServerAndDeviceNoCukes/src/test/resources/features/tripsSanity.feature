...
#    Then user press on "Update" button
    ...
    ### Trip details
    Then user clicks on "Trips" button
    Then user should see the text "Trips"
    Then user should see the text "Today"
    Then user press "Today"
    Then user should see the text "100.0 mi"
    Then user should see the text "Trip started"
    ###
