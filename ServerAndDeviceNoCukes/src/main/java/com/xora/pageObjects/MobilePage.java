...
//    }
    ...
    public String getValue(int index) throws Throwable {
        String txt = driver.findElement(By.xpath("//android.widget.TextView[@index = '" + index + "']")).getText();
        return txt;
    }
...
//        txt.sendKeys(text);
    ...
    public void startTrip_camera(){
        driver.findElement(By.id("com.xora.sprint:id/mileage_starttrip_startOdometerPic")).click();
    }

    public void endTrip_camera(){
        driver.findElement(By.id("com.xora.sprint:id/mileage_endtrip_endOdometerPic")).click();
    }
...
// ********************************SETTINGS PAGE-----------------------
    ...
    public void delete_part(){
     List<WebElement> item_No = driver.findElements(By.id("com.xora.sprint:id/part_row_deletePartButton"));
        item_No.get(0).click();
    }

    public void edit_part(){
        List<WebElement> item_Edit = driver.findElements(By.id("com.xora.sprint:id/list_view_layout"));
        item_Edit.get(0).click();
    }

    public void validate_Parts_values(){
        driver.findElementByName("Parts").getText();
    }
    //Trips Methods
